<template>
  <div class="">
      <div class="py-36">
          <h1 class="text-center text-4xl font-bold">Ready To Build Your Community </h1>
          <div class="flex justify-center items-center">
              <button class="btn btn-primary px-10 py-4 text-white font-semibold my-8 text-lg">Get Started For Free</button>
          </div>
      ...
      <div id="footer">
          <div class="container flex flex-col sm:flex-row-reverse ">
            <div class="flex-1 my-10">
                <h1 class="text-4xl my-2 text-white">NEWSLETTER</h1>
                ...
                <form action="" id="subscribe-form" class="flex flex-col sm:flex-row">
                    <input type="text" class="rounded px-10 py-2 sm:mr-3 my-2">
                    <button class="btn btn-primary px-10 py-2 rounded sm:ml-3 my-2">subscribe</button>
                </form>
          </div>
          <div class="flex-1">
            ...
            <div>
                <div class="flex items-center justify-start">
                    <img src="../assets/icon-phone.svg"  class="w-10 py-2 pr-4 x-2" alt="Phone Icon">
                    <p>Phone: +1-543-123-4567</p>
                </div>
                <div class="flex items-center justify-start">
                    <img src="../assets/icon-email.svg" class="w-10 py-2 pr-4 x-2" alt="Email Icon">
